...
{
    // This function was pulled from a gist that was created by Andy Raddatz thanks to this comment from Alexander on StackOverflow:
    ...
    */
    ...
    /// block) into their ASCII equivalents, if one exists.<br/>
    /// For example, accents are removed from accented characters.<br/>
